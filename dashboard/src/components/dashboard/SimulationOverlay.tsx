...
export function SimulationOverlay() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            {/* Manually implement GlassCard styles to control internal flex layout */}
            <div className={cn(
                "glass-card liquid-glass max-w-4xl w-full border-white/20 shadow-2xl flex flex-col max-h-[90vh] relative transition-all duration-500",
                "group"
            )}>
                <div className="relative z-10 flex flex-col flex-1 min-h-0 bg-transparent">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                                ...
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        step.status === 'completed' ? "bg-emerald-500/10 border-emerald-500/30" :
                                            step.status === 'loading' ? "bg-brand-primary/10 border-brand-primary/40 scale-105 shadow-lg relative z-20" :
                        ...
                        {result && (
                            <div className="animate-in slide-in-from-bottom-5 duration-500">
                                ...
                                <div className="p-6 rounded-2xl bg-white/5 border border-emerald-500/20 shadow-inner mb-8">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        {Object.entries(result.features).slice(0, 5).map(([key, value]: [string, any]) => (
                        ...
                        {currentStep === 2 && !remediation && (
                            <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-white/10 rounded-3xl bg-white/5 animate-pulse mb-8">
                    ...
                    {/* Footer - Fixed */}
                    <div className="flex-none p-6 pt-4 border-t border-white/10 flex justify-end gap-4 bg-black/40 backdrop-blur-sm mt-auto sticky bottom-0 z-20">
                        <button
                            onClick={resetSimulation}
